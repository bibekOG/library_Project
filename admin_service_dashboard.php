...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="innerdiv">
            ...
            <div><label>Branch:</label><input type="radio" name="branch" value="bca"/>BCA<input type="radio" name="branch" value="bbm"/>BBM<div style="margin-left:80px"><input type="radio" name="branch" value="bsw"/>BSW<input type="radio" name="branch" value="bbs"/>BBS</div>
            </div>   
            ...
            <label>Name:</label><input type="text" required name="addname"/>
            </br>
            <label>Pasword:</label><input type="pasword" required name="addpass"/>
            </br>
